...
Export-ModuleMember -Function Initialize-ScriptEnvironment, Cleanup-OnExit, Write-ScriptError
Export-ModuleMember -Function Write-LogDebug, Write-LogInfo, Write-LogSuccess, Write-LogWarning, Write-LogError
Export-ModuleMember -Function Show-Progress, Backup-File, Invoke-Rollback
Export-ModuleMember -Function Test-ProjectStructure, Test-Templates
Export-ModuleMember -Function Get-SanitizedFeatureName, Get-FeatureId
Export-ModuleMember -Function Test-Dependencies, Get-NextFileNumber
Export-ModuleMember -Function Write-Usage, Write-Version

# Export variables
Export-ModuleMember -Variable BackupDir, RollbackStack, ScriptUtilsVersion